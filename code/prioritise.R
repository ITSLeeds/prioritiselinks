...
# piggyback::pb_download("rnet_combined_quietest.Rds", tag = "0.1")
# piggyback::pb_download("osm_highways_region.Rds", tag = "0.1")
# piggyback::pb_download("routes_combined_quietest.Rds", tag = "0.1")

rnet_kildare = readRDS("rnet_combined_quietest.Rds")
# 20117
osm_kildare = readRDS("osm_highways_region.Rds")
